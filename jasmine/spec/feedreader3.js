    ...
    describe('The menu', function(){
         ...
         */
         ...
         beforeEach(function(){
            ...
            hidden = "matrix(1, 0, 0, 1, -192, 0)";
            visible = "matrix(1, 0, 0, 1, 0, 0)";
         ...
         it('default is hidden', function(){
            ...
            expect(computed_style.transform).toBe(hidden);
        ...
        it('visibility toggle works', function(){
            ...
            menu_icon.click();
            console.log($.fx.off);
            console.log(window.getComputedStyle(document.getElementsByClassName("slide-menu")[0]).transform)
            debugger;
      
            expect(window.getComputedStyle(slide_menu).transform).toBe(visible);
            menu_icon.click();
            expect(window.getComputedStyle(slide_menu).transform).toBe(hidden);
         })
